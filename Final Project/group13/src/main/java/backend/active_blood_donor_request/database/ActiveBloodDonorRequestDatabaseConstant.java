package backend.active_blood_donor_request.database;

/**
 * {@code ActiveBloodDonorRequestDatabaseConstant} stores the information related
 * to the active blood donation request database.
 */
public class ActiveBloodDonorRequestDatabaseConstant {
  ...
  // Blood donation request status change date column.
